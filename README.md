Hi, this is moffbot. Github actions proved insufficient for automating managing labels on PRs (SHOCKER), so I wrote
this to do it! :)

Everything below this line is `cargo lambda` templatecruft.
<hr/>


# Introduction

moffbot is a Rust project that implements an AWS Lambda function in Rust.
